...
<body>
    ...
    <div class="add-listing">
        ...
        <div class="button-container">
            ...
            <button type="button" class="next-btn" name="submit_list2" onclick="handleNext()">Next</button>
        </div>
    </form>
    ...
    <script>
        ...
        function handleNext() {
            if (!validateDurationSelection()) {
                return;
            }
            // Logic to move to the next step
            window.location.href = 'personal_details.php'; // Change 'next_step_url.php' to your actual next step URL
        }
