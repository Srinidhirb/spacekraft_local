...
<head>
    ...
    <style>
        ...
        .container_header, .features, .main-content {
            text-align: center;
        }
        .features {
            display: flex;
    ...
    box-sizing: border-box;
        ...
        .banner {
          ...
          background: url('assets/img/renters1.jpg') no-repeat center center/cover;
          display: flex;
      ...
      .marketing-space {
        ...
        width: 100%;
        height: 50vh;
        background-image: url('assets/img/renters3.jpg'); /* Update path to your image */
